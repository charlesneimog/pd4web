...
// include: /var/folders/1w/tgbfzc0x7js09hcqy5tdw_lw0000gp/T/tmp99b_b35g.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/Users/neimog/Downloads/WebPatch/WebPatch/pd4web.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/Users/neimog/Downloads/WebPatch/WebPatch/pd4web.data');

      };
      Module['addRunDependency']('datafile_/Users/neimog/Downloads/WebPatch/WebPatch/pd4web.data');
    ...
    loadPackage({"files": [{"filename": "/index.pd", "start": 0, "end": 1862}], "remote_package_size": 1862});

  })();

// end include: /var/folders/1w/tgbfzc0x7js09hcqy5tdw_lw0000gp/T/tmp99b_b35g.js
// include: /var/folders/1w/tgbfzc0x7js09hcqy5tdw_lw0000gp/T/tmp91ffch2p.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/1w/tgbfzc0x7js09hcqy5tdw_lw0000gp/T/tmp91ffch2p.js
// include: /var/folders/1w/tgbfzc0x7js09hcqy5tdw_lw0000gp/T/tmpvdolsq6t.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/1w/tgbfzc0x7js09hcqy5tdw_lw0000gp/T/tmpvdolsq6t.js
