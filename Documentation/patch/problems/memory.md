...
If you see this, you need to increase the memory size. You can do this in the `pd4web` configuration, using the memory input on Pd patch or the `-m` flag in the command line, for example, `-m 512`.
