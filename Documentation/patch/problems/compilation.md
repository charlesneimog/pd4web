...
-   :construction: __Object not found__:
    -   __Solution:__
        ...
        -   Check how `pd4web` detects objects in [Externals Objects](https://charlesneimog.github.io/pd4web/patch/externals/). If the library is not supported remove the object; if the library is supported, and you did what is in [Externals Objects](https://charlesneimog.github.io/pd4web/patch/externals/), report the issue.
