...
project to benefit from type-checking, auto-completion, and inline documentation. The TypeScript definitions are found [here](https://github.com/charlesneimog/pd4web/blob/main/Sources/Pd4Web/pd4web.d.ts){:target="_blank"}.
