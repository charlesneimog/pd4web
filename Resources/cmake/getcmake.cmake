set(PD4WEB_CMAKE_VERSION "4.3.3")
...
set(CMAKE_URL "https://github.com/Kitware/CMake/releases/download/v${PD4WEB_CMAKE_VERSION}/${CMAKE_ASSET}")
...
if(CMAKE_ASSET MATCHES "\\.zip$")
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -E tar xzf "${CMAKE_ARCHIVE}" WORKING_DIRECTORY "${CMAKE_OUTPUT_DIR}")
...
elseif(APPLE AND EXISTS "${EXTRACTED_DIR}/CMake.app/Contents/bin/cmake")
    file(RENAME "${EXTRACTED_DIR}/CMake.app/Contents/bin/cmake" "${EXTRACTED_DIR}/CMake.app/Contents/bin/cmake-mac")
