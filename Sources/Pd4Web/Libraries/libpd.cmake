...
addreturnaftercomment(${PD_SOURCE_DIR}/s_inter.c "{       /* if there's no TK process just throw it to stderr */"
                      "             return;")
    ...
    if(EXISTS ${source})
        ...
        string(
            REPLACE "~"
                    ...
                    sanitized_name
                    "${name}")
        target_compile_definitions(${sanitized_name} PRIVATE PD)
    endif()
endfunction()
...
# pd_add_external_if_source_exists(stdout ${PD_SOURCE_DIR}/../extra/stdout/stdout.c)

# ╭──────────────────────────────────────╮
# │            Libpd Sources             │
# ╰──────────────────────────────────────╯
set(LIBPD_MAIN_SOURCES
    "${PD_SOURCE_DIR}/x_libpdreceive.c"
    "${PD_SOURCE_DIR}/s_libpdmidi.c"
    "${PD_SOURCE_DIR}/z_hooks.c"
    "${PD_SOURCE_DIR}/z_libpd.c")
