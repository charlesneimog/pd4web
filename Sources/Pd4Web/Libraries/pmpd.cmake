...
# Inline is not supported by emscripten, the sugestition is to use "inline static" Get the list of .c files
function(
    replaceline
    file
    line
...
replaceline("${LIB_DIR}/pmpd~.c" "inline int validate_index(t_pmpd_tilde *x, int idx, t_int count, const char* type)"
            "inline static int validate_index(t_pmpd_tilde *x, int idx, t_int count, const char* type)")
replaceline(
    "${LIB_DIR}/pmpd~.c" "inline int validate_count(t_pmpd_tilde *x, t_int count, t_int count_max, const char* type)"
    "inline static int validate_count(t_pmpd_tilde *x, t_int count, t_int count_max, const char* type)")
replaceline(
    "${LIB_DIR}/pmpd2d~.c" "inline int validate_index(t_pmpd2d_tilde *x, int idx, t_int count, const char* type)"
...
replaceline(
    "${LIB_DIR}/pmpd3d~.c" "inline int validate_index(t_pmpd3d_tilde *x, int idx, t_int count, const char* type)"
