...
#define PD4WEB_PATCH_WIDTH @PD4WEB_PATCH_WIDTH@
#define PD4WEB_PATCH_HEIGHT @PD4WEB_PATCH_HEIGHT@
#define PD4WEB_PATCH_MARGINX @PD4WEB_PATCH_MARGINX@
#define PD4WEB_PATCH_MARGINY @PD4WEB_PATCH_MARGINY@
#define PD4WEB_PATCH_FONTSIZE @PD4WEB_PATCH_FONTSIZE@
